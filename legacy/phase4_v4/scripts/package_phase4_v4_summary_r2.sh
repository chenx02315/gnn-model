...
independent=$base/51_summary/formal_phase4_v4_safe_abstain_three_seed_r1_independent_r2
delivery=$base/60_delivery
package=$delivery/phase4_v4_safe_abstain_summary_r2.tar.gz
extract=$delivery/verified_extract_r2
...
tar -czf "$package" \
  ...
  31_gnn_formal_phase4_v4_safe_abstain/metadata/scripts_r4.sha256 \
  ...
  51_summary/formal_phase4_v4_safe_abstain_three_seed_r1_independent_r2/independent_per_seed.tsv \
  51_summary/formal_phase4_v4_safe_abstain_three_seed_r1_independent_r2/independent_aggregate.tsv \
  51_summary/formal_phase4_v4_safe_abstain_three_seed_r1_independent_r2/independent_infeasible_selections.tsv \
  51_summary/formal_phase4_v4_safe_abstain_three_seed_r1_independent_r2/independent_summary.json \
  51_summary/formal_phase4_v4_safe_abstain_three_seed_r1_independent_r2/independent_outputs.sha256
